...
class Sport extends Component {
  ...
  getAll() {
    fetch("http://localhost:3020/sport/list", { method: "GET" })
  ...
  render() {
    let { sport, currentPage, todosPerPage } = this.state;
    ...
    let currentTodos = sport.slice(indexOfFirstTodo, indexOfLastTodo);


    prev = currentPage > 0 ? (currentPage - 1) : 0;

    last = Math.ceil(sport.length / todosPerPage);
              ...
              <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">
                <div class="filter-widget">
                  ...
                  <ul class="filter-catagories">
                    <li><a href="#">Sport clothings</a></li>
